...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 bg-bg-main relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          ...
          <h2 className="font-serif text-4xl sm:text-5xl font-extrabold text-primary mb-6">World-Class Dental Solutions</h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto font-medium">Advanced procedures, digital precision, and gentle care tailored to restore your perfect smile.</p>
        </motion.div>
          ...
          {treatments.slice(0, 6).map((service, index) => {
            return (
              <motion.div 
                ...
                className="group relative h-[380px] rounded-[2rem] overflow-hidden bg-white hover:-translate-y-2 transition-all duration-500 cursor-pointer border-2 border-transparent hover:border-cyan/30"
              ...
              >
                ...
                <div className="relative z-10 p-8 h-full flex flex-col justify-end">
                  ...
                  <h3 className="font-bold text-white mb-4 text-2xl">{service.title}</h3>
                ...
                <div className="absolute inset-0 z-20 pointer-events-none rounded-[2rem] ring-1 ring-inset ring-white/20 group-hover:ring-cyan/50 transition-all duration-500" />
              </motion.div>
            );
          })}
        </div>
