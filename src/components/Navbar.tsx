      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex flex-col bg-transparent">
        ...
        <motion.nav
          ...
          className={`transition-all duration-300 border-b ${isScrolled
            ? 'bg-white/70 backdrop-blur-2xl shadow-lg border-white/20 py-2'
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden lg:flex items-center gap-3">
                <a href="tel:9551120208" className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${isScrolled
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.2 }}
            className="fixed inset-0 z-40 bg-bg-main/95 backdrop-blur-xl pt-32 px-6 pb-6 overflow-y-auto lg:hidden"
          >
