            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="https://share.google/nhwKj6EY2zqraPrCG" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-cyan transition-colors"><Star size={20} /></a>
                </div>
              </div>
            </div>
