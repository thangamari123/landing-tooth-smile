...
export const treatments: Treatment[] = [
  {
    ...
    tagline: 'Permanent replacement for missing teeth that look and function like natural teeth.',
    ...
    overview: 'Dental implants are the gold standard for replacing missing teeth. A titanium post is surgically placed into the jawbone, acting as an artificial tooth root. Once healed, a custom crown is attached, giving you a permanent, natural-looking tooth.',
    description: [
    ...
    beforeAfter: [
      { title: 'Single Tooth Replacement', desc: 'Front tooth implant with zirconia crown', beforeImg: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=600&q=80' },
      { title: 'Multiple Implants', desc: 'Three-unit bridge supported by two implants', beforeImg: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=600&q=80' },
    ],
  },
  {
    ...
    tagline: 'Painless treatment to remove infection and save your natural tooth.',
    ...
    overview: 'Root Canal Treatment (RCT) saves infected or damaged teeth from extraction. Using advanced rotary endodontics and digital imaging, we precisely clean and seal the root canals to eliminate infection and preserve your natural tooth.',
    description: [
    ...
    beforeAfter: [
      { title: 'Infected Molar Saved', desc: 'Severely infected molar restored with RCT and crown', beforeImg: 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=600&q=80' },
    ],
  },
  {
    ...
    tagline: 'Straighten teeth and correct bite for a better smile.',
    ...
    overview: 'Whether you prefer traditional braces or invisible aligners, we offer customized orthodontic solutions for all ages. Using digital smile design, we plan your treatment with precision for predictable, beautiful results.',
    description: [
    ...
    benefits: [
      ...
      'Improves oral hygiene by reducing hard-to-clean areas',
      'Enhances facial aesthetics and smile confidence',
      'Prevents premature wear on teeth',
      'Multiple options: metal, ceramic, lingual, aligners',
      'Digital preview of expected results',
    ],
    faqs: [
    ...
    beforeAfter: [
      { title: 'Crowded Teeth Correction', desc: 'Severe crowding resolved with 18-month braces treatment', beforeImg: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=600&q=80' },
      { title: 'Open Bite Correction', desc: 'Open bite closed with comprehensive orthodontic treatment', beforeImg: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=600&q=80' },
    ],
  },
  {
    ...
    tagline: 'Professional whitening for a brighter, confident smile.',
    ...
    overview: 'Our professional teeth whitening treatments deliver dramatic results in a single visit. Using medical-grade whitening agents and LED acceleration, we safely remove deep stains caused by coffee, tea, smoking, and aging.',
    description: [
    ...
    benefits: [
      'Instant results – up to 8 shades lighter in one visit',
      'Safe and supervised by dental professionals',
      'Removes deep stains that home kits cannot touch',
    ...
    beforeAfter: [
      { title: 'Heavy Stain Removal', desc: 'Years of coffee and tobacco stains removed in one session', beforeImg: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=600&q=80' },
    ],
  },
  {
    slug: 'smile-makeover',
    ...
    tagline: 'Complete smile transformation with veneers, crowns, and cosmetic bonding.',
    ...
    overview: 'A smile makeover combines multiple cosmetic procedures to transform your smile completely. From porcelain veneers and crowns to gum contouring and teeth whitening, we design a treatment plan tailored to your facial features and goals.',
    description: [
    ...
    beforeAfter: [
      { title: 'Full Smile Transformation', desc: 'Complete makeover with 8 porcelain veneers', beforeImg: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=600&q=80' },
      { title: 'Gapped Teeth Correction', desc: 'Diastema closed with veneers and whitening', beforeImg: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=600&q=80' },
    ],
  },
  {
    slug: 'crowns-bridges',
    ...
    shortTitle: 'Crowns',
    metaTitle: 'Dental Crowns & Bridges in Mylapore, Chennai | Tooth & Smile',
    metaDesc: 'Restore damaged teeth with precision-crafted crowns and bridges. Same-day crown options available. In-house dental lab in Mylapore, Chennai.',
    tagline: 'Restore damaged teeth and replace missing teeth with precision-crafted prosthetics.',
    image: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?w=800&q=80',
    heroImage: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?w=1920&q=80',
    duration: '1-2 visits (same-day options available)',
    recovery: 'Mild sensitivity for 1-2 days',
    costRange: 'Starting from ₹5,000 per crown',
    overview: 'Our crowns and bridges are crafted in our in-house dental lab using premium materials like zirconia, porcelain-fused-to-metal, and all-ceramic options. Each restoration is custom-designed for a perfect fit and natural appearance.',
    description: [
      'At Tooth & Smile, we offer a wide range of crown materials to suit every need and budget. From economical metal crowns to premium zirconia and E-max all-ceramic crowns, we help you choose the best option for your situation.',
      'Our in-house dental lab, equipped with CAD/CAM technology, allows us to deliver same-day crowns for many cases. This means fewer visits and faster results without compromising on quality.',
      'For missing teeth, we offer both traditional bridges and implant-supported bridges. Dr. R. R. Murali Karthik evaluates your bone condition, bite, and aesthetic needs to recommend the most suitable solution.',
    ],
    procedure: [
      'Examination and treatment planning',
      'Tooth preparation and digital impressions',
      'Shade matching for natural appearance',
      'Crown/bridge fabrication in our lab',
    ...
    benefits: [
      ...
      'Durable materials that last 10-15+ years',
      'Protects weakened teeth from further damage',
      'In-house lab ensures perfect fit and fast delivery',
    ],
    faqs: [
      { q: 'How long does a dental crown last?', a: 'With proper care, crowns last 10-15 years or longer. Zirconia and all-ceramic crowns tend to have the longest lifespan.' },
      { q: 'Do same-day crowns look as good as lab-made ones?', a: 'Yes! Our CAD/CAM same-day crowns use premium ceramic blocks and are milled with precision. They offer excellent aesthetics and fit.' },
      { q: 'What is the difference between a crown and a bridge?', a: 'A crown covers a single damaged tooth. A bridge replaces one or more missing teeth by anchoring to adjacent teeth or implants.' },
      { q: 'Will the crown match my natural teeth?', a: 'Absolutely. We use advanced shade-matching systems and our lab technicians are experts at creating natural-looking restorations.' },
      { q: 'How much does a crown cost?', a: 'Crowns start from ₹5,000 (metal) to ₹15,000+ (premium zirconia/E-max). Bridges are priced based on the number of units. We provide detailed estimates.' },
    ],
    beforeAfter: [
      { title: 'Broken Tooth Restoration', desc: 'Fractured molar restored with zirconia crown', beforeImg: 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=600&q=80' },
      { title: 'Missing Teeth Bridge', desc: 'Three-unit bridge replacing missing front teeth', beforeImg: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=600&q=80', afterImg: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=600&q=80' },
    ],
  },
];
